...
<picture>
  ...
  <img src="https://raw.githubusercontent.com/kbssrikar7/kbssrikar7/main/assets/stack-light.svg" width="660" alt="Python, TypeScript, JavaScript, Java, C++, Rust, Swift, Ruby, React, Next.js, FastAPI, Django, Rails, TensorFlow, Jupyter, Tauri, PostgreSQL, Supabase, Docker, Linux, Arduino, MQTT, Vercel, Azure, n8n, AWS, Kotlin, SQLite, Firebase, Expo, Qdrant, LangChain, Hugging Face, GitHub Actions, GNU Bash, Google Cloud" />
</picture>
...
`Swift` `Rust` `C++` `Kotlin` `CoreAudio` `PipeWire` `WASAPI`
